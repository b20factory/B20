  ...
  return (
    <header className="sticky top-0 z-30 border-b border-line bg-bg/90 backdrop-blur-md">
      <div className="wrap flex items-center gap-2 h-16">
        ...
        {IS_TESTNET && <span className="hidden sm:inline-flex chip border-warn/30 text-warn ml-1">Testnet</span>}
      ...
      {menu && (
        <nav className="md:hidden border-t border-line bg-bg px-3 py-3 space-y-0.5 animate-fade-up">
          ...
          <div className="pt-2 px-1 flex items-center gap-2">
            ...
            {IS_TESTNET && <span className="chip border-warn/30 text-warn">Testnet</span>}
          </div>
        </nav>
      )}
    </header>
